...
class ConfusionMatrix(object):
    ...
    def summary(self):
        ...
        # precision, recall, specificity, accuracy for each class
        table = PrettyTable()
        ...
        for i in range(self.num_classes):
            ...
            Accuracy = round(TP / (TP + FP + FN), 3) if TP + FP + FN != 0 else 0.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default=r"E:\cornleaf\deep-learning-for-image-processing-master\pytorch_classification\data\Cassava - 副本")
